...
# Connect the public subnet to the Internet
...
# NAT gateways to allow the private subnets to reach the EKS Service (Kubernetes support)
# eip is an elastic IP - this is a real Internet address (cost money?)
